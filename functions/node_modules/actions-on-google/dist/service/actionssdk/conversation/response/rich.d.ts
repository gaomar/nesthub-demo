...
/** @public */
export declare type RichResponseItem = string | SimpleResponse | BasicCard | Table | BrowseCarousel | MediaResponse | OrderUpdate | LinkOutSuggestion | ImmersiveResponse | Api.GoogleActionsV2RichResponseItem;
/** @public */
